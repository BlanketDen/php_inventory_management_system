...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card" style="width: 18rem; border-style:solid; border-width: 1px; border-radius: 10px; float: left; margin-left: 5px">
            <div class="card-body">
                <h3 class="card-title text-center">Total Companies</h3>
                <h1 class="card-text text-center">
                <?php 
                $count=0;
        ...
        <div class="card" style="width: 18rem; border-style:solid; border-width: 1px; border-radius: 10px; float: left; margin-left: 5px">
            <div class="card-body">
                <h3 class="card-title text-center">Total Purchased Products</h3>
                <h1 class="card-text text-center">
                <?php 
                $count=0;
        ...
        <div class="card" style="width: 18rem; border-style:solid; border-width: 1px; border-radius: 10px; float: left; margin-left: 5px">
            <div class="card-body">
                <h3 class="card-title text-center">Total Returned Products</h3>
                <h1 class="card-text text-center">
                <?php 
                $count=0;
