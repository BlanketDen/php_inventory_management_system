...
<div id="header">
    ...
    <h2 style="color: white;position: absolute">
        <a href="dashboard.html" style="color:white; margin-left: 30px; margin-top: 40px">ToolStore</a>
    </h2>
</div>
...
<div id="sidebar">
    <ul>
        ...
        <li >
            <a href="add_new_party.php"><i class="icon icon-group"></i><span>Add New Party</span></a>
        </li>

        <li >
            <a href="add_new_unit.php"><i class="icon icon-exchange"></i><span>Add New Unit</span></a>
        </li>

        <li >
            <a href="add_company.php"><i class="icon icon-building"></i><span>Add New Company</span></a>
        </li>

        <li >
            <a href="add_products.php"><i class="icon icon-shopping-cart"></i><span>Add New Products</span></a>
        </li>
